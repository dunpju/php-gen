...
class DaoCommand extends BaseCommand
{
    ...
    public function configure()
    {
        ...
        $this->setDescription($description . 'php bin/hyperf.php dengpju:dao model=all --conn=default --modelPath=Default Or php bin/hyperf.php dengpju:dao model=ModelName --conn=default --modelPath=Default');
